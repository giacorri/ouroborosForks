...
NON_VIABLE_FORK.tree.add_node("2 a1", weight=2, type="a", n=1)
NON_VIABLE_FORK.tree.add_edge("0", "2 a1")
NON_VIABLE_FORK.tree.add_node("4 a1", weight=4, type="a", n=1)
NON_VIABLE_FORK.tree.add_edge("2 a1", "4 a1")
NON_VIABLE_FORK.tree.add_node("6 a1", weight=6, type="a", n=1)
NON_VIABLE_FORK.tree.add_edge("4 a1", "6 a1")

NON_VIABLE_FORK.tree.add_node("1", weight=1, type="h", n=0)
NON_VIABLE_FORK.tree.add_edge("0", "1")
NON_VIABLE_FORK.tree.add_node("2 a2", weight=2, type="a", n=2)
NON_VIABLE_FORK.tree.add_edge("1", "2 a2")
NON_VIABLE_FORK.tree.add_node("3", weight=3, type="h", n=0)
NON_VIABLE_FORK.tree.add_edge("2 a2", "3")
NON_VIABLE_FORK.tree.add_node("4 a2", weight=4, type="a", n=2)
NON_VIABLE_FORK.tree.add_edge("3", "4 a2")
NON_VIABLE_FORK.tree.add_node("5", weight=5, type="h", n=0)
